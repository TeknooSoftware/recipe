Feature: Cookbook from trait
  ...
  Scenario: Train a chef to cook dish from a cookbook with the base trait
    ...
    And I have a cookbook with the base trait for date management to get "2017-07-01 10:00:00"
  ...
  Scenario: Train a chef to cook dish from trait with cookbook instance overwritting in the worplan
    Given I have an empty recipe
    And I have a cookbook with the base trait for date management to get "2017-07-01 10:00:00"
