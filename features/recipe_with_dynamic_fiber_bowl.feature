Feature: Recipe with dynamic fiber bowl
  ...
  Scenario: Add a step to a recipe
    Given I have an empty recipe
    When I define the dynamic fiber step "createImmutable" my recipe
    Then I should have a new recipe.
  ...
  Scenario: Create a complex dynamic fiber recipe
    Given I have an empty recipe
    When I define a "\DateTime" to start my recipe
  ...
  Scenario: Train a chef to cook a dynamic fiber dish
    Given I have an empty recipe
  ...
  Scenario: Train a chef to cook a dynamic fiber dish without non mandatory callable
    Given I have an empty recipe
    And I have an untrained chef
    When I define a "\DateTime" to start my recipe
    When I define the dynamic fiber step "createImmutable" my recipe
  ...
  Scenario: Train a chef to cook a dynamic fiber dish with a mandatory step
    Given I have an empty recipe
    And I have an untrained chef
    When I define a "\DateTime" to start my recipe
    When I define the mandatory dynamic fiber step "createImmutable" my recipe
    When I set the dynamic callable "createImmutable" to "DateTimeImmutable::createFromMutable" my recipe
    And I define the excepted dish "DateTimeImmutable" to my recipe
    And I must obtain an Immutable DateTime at "2017-07-01 10:00:00"
    When I train the chef with the recipe
  ...
  Scenario: Train a chef to cook a dynamic fiber dish without callable with a mandatory step
    Given I have an empty recipe
    And I have an untrained chef
    When I define a "\DateTime" to start my recipe
    When I define the mandatory dynamic fiber step "createImmutable" my recipe
