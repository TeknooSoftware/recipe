Feature: Recipe with named step
  ...
  Scenario: Create a complex recipe with repeated actions with same name
    ...
    When I define the step "step1" to do "\StringObject::addTest" my recipe
    When I define the step "step2" to do "\StringObject::addTest" my recipe
    When I define the step "step3" to do "\StringObject::addTest" my recipe
    When I define the step "step2" to do "\StringObject::addTest" my recipe
    When I define the step "step4" to do "\StringObject::addTest" my recipe
    When I define the step "step4" to do "\StringObject::addTest" my recipe
    When I define the excepted dish "\StringObject" to my recipe
  ...
  Scenario: Train a chef to cook a dish with goto to actions
    ...
    When I define a "\StringObject" to start my recipe
    When I define the step "addTest1" to do "\StringObject::addTest" my recipe
    When I define the step "addTest2" to do "\StringObject::gotTo" my recipe
    When I define the step "addTest3" to do "\StringObject::addTest" my recipe
    When I define the step "addTest3" to do "\StringObject::addTest" my recipe
    When I define the step "final" to do "\StringObject::addTest" my recipe
    When I define the step "final" to do "\StringObject::addTest" my recipe
